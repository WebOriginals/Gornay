  ...
  function initMap() {
      ...
      var contentString =
          '<div class="info__item"><div class="info__title" style="font-size:1.1em;">Labsales</div><div class="info__address">г. Краснодар, ул. 70-летия Октября, д. 34/3</div></div>';
      ...
      new google.maps.Marker({
          ...
          map: map,
        //   icon: 'img/baloon.png'
          icon: '/labsite_static/img/contacts/baloon.svg' 
